...
class LevitatorArray:
    ...
    def _build_shell(self, sign):
        ...
        for ang, n in zip(self._RING_ANGLES, self._RING_COUNTS):
            ...
            z = -sign * (self.Rc * np.cos(ang))    # axial coordinate
...
class PhaseControl:
    ...
    def standing_wave(self, delta=0.0):
        ...
        delta : extra phase offset [rad] that shifts the standing-wave nodes
                along the axis (this is the mechanism for vertical movement).
        """
        phases = []
